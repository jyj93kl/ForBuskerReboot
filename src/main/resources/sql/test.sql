...
CREATE TABLE MEMBER (
 ...
 CREATE TABLE NOTICE (
  ...
  CONTACTUS_NUM INT NOT NULL AUTO_INCREMENT,
  CONTACTUS_EMAIL VARCHAR(100),
  CONTACTUS_TITLE VARCHAR(100),
  CONTACTUS_CATEGORI VARCHAR(45),
  CONTACTUS_CONTENT VARCHAR(2000),
  CONTACTUS_WRITER VARCHAR(100),
  CONTACTUS_DATE DATE,
  CONSTRAINT PRIMARY KEY (`CONTACTUS_NUM`)
) engine=InnoDB;
